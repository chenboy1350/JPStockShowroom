...
[PrimaryKey("ReceiveNo", "Id")]
[Table("SPDReceive", Schema = "dbo")]
public partial class Spdreceive
{
    [Key]
    [StringLength(10)]
    [Unicode(false)]
    ...
    [ForeignKey("ReceiveNo")]
    [InverseProperty("Spdreceive")]
    public virtual Sphreceive ReceiveNoNavigation { get; set; } = null!;
}
